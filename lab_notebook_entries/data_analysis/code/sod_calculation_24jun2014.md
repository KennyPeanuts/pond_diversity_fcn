...
### Import Data
    ...
    std <- read.delim("./data/winkler_standardization_24jun2014.csv", header = T,  sep = ",")
    repl <- read.delim("./data/repl_water_24jun2014.csv", header = T,  sep = ",")
...
###Calculations
    ...
    ## Make Data Table
    write.table(flux, "./data/sod_calculation_24jun2014.csv", quote = F, row.names = F, sep = ",")
