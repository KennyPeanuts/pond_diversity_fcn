...
### Data entry
    ...
    stds <- c(1.25, 1.21, 1.21) 
    blank.first <- c(1.21, 1.25, 1.25)
    blank.second <- c(2.50, 2.51, 2.54)
    Vstd <- 0.2
    MnCl.vol <- 0.085
    NaI.vol <- 0.085
    Nstd <- 0.01
...
## Output
    ...
    write.table(std, file = "./data/winkler_standardization_1jul2014.csv", quote = F, row.names = F, sep = ",")
